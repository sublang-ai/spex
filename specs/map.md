...
| [DR-035](decisions/035-intent-ledger.md) | 035-intent-ledger.md | The intent ledger: intents as staged Boss turns, one-gesture capture from issues/PRs/records/chat, per-project committed queues with one after-link, verdict-owed deliveries, standing-aware Dashboard; presentation amended by DR-077 |
...
| [DR-055](decisions/055-queue-advancement.md) | 055-queue-advancement.md | Queued work advances independently of human confirmation; the clean-settlement gate is amended by DR-077 |

...
- The "no Electron coupling of app features" rule of the app-shell package is preserved in spirit and amended in letter; [[app-shell-20](../packages/app-shell.md#app-shell-20)] records the constraint.

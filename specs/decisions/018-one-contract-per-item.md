...
- GEARS [[meta-6](../meta.md#meta-6)] is a single-sentence template, [[meta-25](../meta.md#meta-25)] already puts each sentence on its own line for diffs, and the binding rule already demanded one sentence of bindings — with lint enforcement.
...
- **[[meta-21](../meta.md#meta-21)] splits along its concerns**, keeping its reserved headline under [[meta-12](../meta.md#meta-12)]: it keeps the integration/system scope with the unit-test exclusion, while package-test placement and isolation, composition-test placement with its citation duties and floors, binding/scenario coverage, and acceptance-versus-inspection grading each take an item of their own.
  Citations re-point per claim: the Verification row of [[meta-30](../meta.md#meta-30)] to the package-test item; the binding realization question in the binding rule and the composition citation duties in [[meta-20](../meta.md#meta-20)] to the composition-test item; lint's floor and coverage rules to the composition-test and coverage items.
- **[[meta-1](../meta.md#meta-1)] re-homes its second sentence**: record identity moves to [[meta-39](../meta.md#meta-39)], making the layout item itself one sentence plus its table.
...
- Meta items and records are outside [[meta-29](../meta.md#meta-29)]'s classes; they follow the discipline editorially, as this decision's own edits do.

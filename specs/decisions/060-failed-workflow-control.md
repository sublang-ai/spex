...
Amended by [DR-075](075-a-failure-says-what-and-what-now.md): the notice says why the run failed and what to do, from data, and draws each advertised action as its own control.

...
- The nav badge derives from the same attention rules [[dashboard-1](../packages/dashboard.md#dashboard-1)] as the Dashboard [[dashboard-9](../packages/dashboard.md#dashboard-9)], so the two never disagree.

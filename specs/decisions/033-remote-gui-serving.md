...
- It serves `index.html` with the CSP `connect-src` retargeted to the serving origin; the bundle is otherwise served as built, keeping the desktop's `file://` copy byte-identical.

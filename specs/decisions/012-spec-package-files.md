...
- Two item directories replace the three folders ([DR-000](000-spec-structure-format.md)):
  - `specs/packages/` — one file per package with `## External Behavior`, `## Internal Behavior`, and `## Verification` sections [[meta-15](../meta.md#meta-15)]; one read covers a package.

...
- [x] Conversation-first run view: player questions render as
...
- [x] Honest async: per-class command timeouts (compile never
...
- [x] Session lifecycle guardrails: inline confirm to end any live
...
- [x] First-run integrity: readiness entries for adapter-shorthand
...
- [x] Keyboard & accessibility baseline: global shortcuts
  ...
  and dark-mode pairs
- [x] One visual grammar: SVG icon component replacing color-emoji
...
- [x] Microcopy: "Playbooks" nav; Projects add/create labels;
...
- [x] Specs: DR-010 recorded; affected user/dev/test spec items

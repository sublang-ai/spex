...
- [x] Project chip menu with Open folder…/path fallback and silent git init for non-repo folders ([[run-view-26](../packages/run-view.md#run-view-26)]/[[run-view-27](../packages/run-view.md#run-view-27)])
...
- [x] Tests per [[run-view-29](../packages/run-view.md#run-view-29)]/[[run-view-31](../packages/run-view.md#run-view-31)]; live verification against the fake core (auto-init observed on disk) and Electron acceptance

## Tasks

1. Realized across the commits referencing `IR-012`.

## Verification

- Root build/test green; [[run-view-29](../packages/run-view.md#run-view-29)]/[[run-view-31](../packages/run-view.md#run-view-31)] pass.

...
| Session question | the next Boss turn starting in the session, or the parked run ending within a turn — Drop on that run's own notice [[run-view-128](run-view.md#run-view-128)] ([DR-073](../decisions/073-letting-go-ends-the-parked-run.md)) |

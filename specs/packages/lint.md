...
- an error for a DR citation not written as a plain relative link to its file with the record ID as link text, e.g. `[DR-000](../decisions/000-spec-structure-format.md)` [[meta-16](../meta.md#meta-16)]; intent records carry no stated form, so none is enforced;

...
Files under `compositions/` shall describe how the installed system is composed: packages working together, and open needs bound to suppliers or services.

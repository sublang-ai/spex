...
picker, and the stored reference shall be the chosen asset's
stable identifier
...
course page shall mark exactly the attachment-carrying lessons
as playable
...
the course and its syllabus shall remain intact
([CAT-10](../packages/catalog/course-catalog.md#cat-10)), the
lesson view shall fall back to its no-media presentation, and
the course manager shall mark the lesson's dangling reference so
the admin can reattach or clear it.

## Tests

### PUB-4
Verifies: [PUB-1](#pub-1), [PUB-2](#pub-2), [ROLE-2](../packages/identity/access-control.md#role-2), [CAT-5](../packages/catalog/course-catalog.md#cat-5), [CAT-8](../packages/catalog/course-catalog.md#cat-8), [VID-1](../packages/catalog/video-library.md#vid-1)
...
### PUB-5
Verifies: [PUB-3](#pub-3), [CAT-10](../packages/catalog/course-catalog.md#cat-10), [VID-10](../packages/catalog/video-library.md#vid-10)
...
shall assert the course page still shows the full syllabus, the
lesson view shows the no-media presentation, and the course
manager marks the dangling reference.
